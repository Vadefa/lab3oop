...
/* Основная мысль этой лабы:
* У тебя есть класс для хранилища, который только добавляет и удаляет из себя уже созданные объекты других классов.
* У тебя есть пустой класс, от которого наследуются другие классы, за исключением хранилища. У него есть перекрытые (виртуальные) методы.
* Другие классы унаследованы от пустого класса и они уже не пустые, а что-то делают.
* 
* У меня:
* Пустой класс - Obj
* Наследники этого класса - One, Boom, Earth, Continent
* Класс-хранилище - MyStorage
*/
